...
class EditInput(ctk.CTkToplevel):
    def __init__(self, parent, day, order):
        ...
        self.applyChangesButton.grid(
            row=6, column=1, columnspan=1, padx=20, pady=20, sticky="ew"
        )
        ...
        self.deleteOrderButton.grid(
            row=6, column=0, columnspan=1, padx=20, pady=20, sticky="ew"
        )

    def apply_changes(self):
        print(f"Current Window Size: {self.winfo_width()} x {self.winfo_height()}")
